package demo.texasholdem.poker.impl;

import java.util.Arrays;

import demo.texasholdem.poker.Equity;
import demo.texasholdem.poker.MEquity;
import demo.texasholdem.poker.MEquityUtil;
import demo.texasholdem.poker.MathsUtil;
import demo.texasholdem.poker.Poker;
import demo.texasholdem.poker.Value;
...
public class HEPoker extends Poker {
	...
	public int value(String[] board, String[] hole) {
		...
		if (board == null || board.length < 3) {
			// could use the draw demo.texasholdem.poker getPair method...
			return 0;
