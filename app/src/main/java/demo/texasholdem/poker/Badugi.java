...
import static demo.texasholdem.poker.Poker.face;
import static demo.texasholdem.poker.Poker.faceValueAL;
import static demo.texasholdem.poker.Poker.suit;
import static demo.texasholdem.poker.Poker.valueFace;


/**
 * methods for badugi valuation. note this doesn't subclass Poker, as badugi is
 * hand valuation only, the game is otherwise the game as draw demo.texasholdem.poker
 */
public class Badugi {
